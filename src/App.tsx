                                    ...
                                    <div key={juegoIndex} className="fade-in" style={{ height: '100%', background: 'linear-gradient(135deg, #1e3a8a, #1e40af)', color: 'white', padding: 20, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                        ...
                                        <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
                                            ...
                                            >
                                                ...
                                                {/* Avatar canal liga */}
                                                <img src="https://i.postimg.cc/NFJGKF0G/image.png" style={{ width: 16, height: 16, borderRadius: '50%', objectFit: 'cover', flexShrink: 0, border: '1px solid rgba(255,255,255,0.4)' }} alt="" />
                                                LIGA
                                            </button>
                                            ...
                                            >
                                                ...
                                                {/* Avatar canal barba */}
                                                <img src="https://i.postimg.cc/mrfLz0TF/image.png" style={{ width: 16, height: 16, borderRadius: '50%', objectFit: 'cover', flexShrink: 0, border: '1px solid rgba(255,255,255,0.4)' }} alt="" />
                                                BARBA
                                            </button>
                                        </div>
                                    </div>
